...
class DefendantStatePage extends StatefulWidget {
  @override
  _DefendantStatePageState createState() => _DefendantStatePageState();
}

class _DefendantStatePageState extends State<DefendantStatePage> {
  ...
  Future _speak() async {
    ...
    var result = await flutterTts.speak(defState);
